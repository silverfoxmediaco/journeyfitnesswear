...
export type MensProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type MensProductsQuery = {
...
export type WomensProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type WomensProductsQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      products: {
        nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  #graphql\n  fragment HomepageProduct on Product {\n    id\n    handle\n    title\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n\n  query MensProducts($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collection(handle: "mens") {\n      id\n      title\n      handle\n      products(first: 9, sortKey: BEST_SELLING) {\n        nodes {\n          ...HomepageProduct\n        }\n      }\n    }\n  }\n': {
    return: MensProductsQuery;
    variables: MensProductsQueryVariables;
  };
  '#graphql\n  #graphql\n  fragment HomepageProduct on Product {\n    id\n    handle\n    title\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n\n  query WomensProducts($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collection(handle: "womens") {\n      id\n      title\n      handle\n      products(first: 9, sortKey: BEST_SELLING) {\n        nodes {\n          ...HomepageProduct\n        }\n      }\n    }\n  }\n': {
    return: WomensProductsQuery;
    variables: WomensProductsQueryVariables;
  };
